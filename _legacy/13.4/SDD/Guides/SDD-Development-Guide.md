...
**`AG-00980`, el bibliotecario, existe pero todavía no se convoca.** Su contrato está en `Rules-Base-Conocimiento.md` §9 y su identificador está acuñado en `Root-Rules.md` §9.2. Lo que falta es el aviso en el despacho que le dice al subagente que la biblioteca existe y cómo pedir. Mientras tanto el conocimiento llega por condición y por cita, que es el camino determinista y el que cubre el caso común.
