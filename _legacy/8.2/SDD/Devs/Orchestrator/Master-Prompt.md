...
| B | 02-Especificacion-Funcional | proyecto de código | `Especificacion-Funcional.md`, `Casos-De-Uso/CU-XXXXX-<Nombre>.md`, `Reglas-De-Negocio/RN-XXXXX-<Nombre>.md` (si aplica), `Modelo-Datos/...` (si hay persistencia), `Glosario-Funcional.md`, `README.md` | Analista Funcional Senior (AG-02) + variante D8 del proyecto de código | 01/NB-XXXXX, 00; README §5 P.x del proyecto de código | `Rules-Especificacion-Funcional.md` | `SDD/Docs/Proyectos/<Nombre>/02-Especificacion-Funcional/` | Sí |
...
| I | 10-Examples, pasada de ejecución | proyecto de código | Samples implementados y corridos; campo `evidencia` de cada `VER-XXXXX` con la salida real y su fecha | Developer Advocate / Sample Engineer Senior (AG-10) | Código construido; 10 de la pasada de diseño | `Rules-Examples.md` §0.2 | `SDD/Docs/Proyectos/<Nombre>/10-Examples/` y `/samples/` | Sí (acotado al incremento) |
...
1. **Enlaces y anclas** sobre el árbol de la fase: toda referencia resuelve.
