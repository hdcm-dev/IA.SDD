...
**Versión:** 9.1 — el ítem diferido 4 de §8 se cierra en SDD 13.6; el resto es la 9.0, octava reemisión, tras nueve rondas de auditoría, un ciclo de mejora continua con panel de nueve especialistas y jurado de cinco, y la autorización del paso 1 de §III.7
**Fecha:** 2026-08-23
...
| 4 | ~~**El bloque `009xx` no tiene regla de asignación interna**~~ **CERRADO en SDD 13.6.** `Root-Rules.md` §9.2 escribe el reparto: `009N0` descendiendo desde `00990` para los roles, `009N1` a `009N9` para sus subagentes de fase | El motivo del diferimiento era que **no había un segundo rol que forzara la decisión**. `AG-00980`, acuñado en la **13.2**, lo fue: el evento de cierre ocurrió y el ítem quedó abierto **tres versiones**, que es el hallazgo P1 de `Root-Rules.md` §12.2 | La organización dueña del repositorio | **Ocurrido y cerrado** |
