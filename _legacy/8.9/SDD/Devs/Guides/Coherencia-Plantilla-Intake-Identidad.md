...
demás secciones que nombran ese nivel**.

**Se incorporó en la 8.9**, tratando los tres casos juntos como esta nota pedía: `SDD-Development-Guide.md`
**§VI.3.1** define el **barrido por concepto** y suma dos comprobaciones a la lista de VI.3 —el barrido
en todo el árbol **incluyendo el interior de lo ya tocado**, y la **coherencia interna de cada
artefacto**—. El README raíz suma la fila correspondiente a su tabla de reglas de intervención.

**La cuarta regla del procedimiento es la que esta nota hizo falta para escribir**: la pregunta final
de toda intervención no es «¿toqué todo lo que había que tocar?» sino **«¿mi intervención cometió el
defecto que corrige?»**. En los tres casos la respuesta era sí, y en los tres se podía haber
contestado antes de publicar.
...
| 1.1 | 2026-08-16 | §6 pasa de «lo que no resuelve» a **cómo se cerró**: la 8.9 incorpora el **barrido por concepto** en `SDD-Development-Guide.md` §VI.3.1, tratando los tres casos juntos como esta nota pedía. |
