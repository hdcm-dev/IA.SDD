...
Las 13 especialidades son las que producen artefactos documentales: una por cada una de las 12 categorías de `Docs/` más AG-00990. Hay además dos roles que **no son titulares de ninguna categoría** y por eso no alteran ese número. El segundo es **AG-00980**, el bibliotecario de conocimiento, que resuelve pedidos contra el catálogo `Conocimiento/` devolviendo identificadores y nunca texto, y cuyo contrato vive en `Rules-Base-Conocimiento.md` §9. El primero lo incorpora la Fase B2 de validación visual (§8.8): AG-00031, materializa en una maqueta la especificación que AG-00030 redactó, y los documentos que emite quedan bajo la titularidad documental de las categorías 03 y 08. Es un subagente de fase, no de categoría. La distinción importa porque es la que mantiene el criterio de un responsable por artefacto: si AG-00031 fuera titular de la experiencia, habría dos especialidades decidiendo sobre el mismo documento.
...
| 3.8 | 2026-08-23 | **§4.1 suma `AG-00980` al recuento de roles que no son titulares de categoría** (conjunto 13.2). La sección explicaba por qué las trece especialidades no cambian de número al aparecer un subagente de fase, y ese razonamiento ya cubría al bibliotecario, pero **el rol no estaba nombrado**: el catálogo describía una nómina incompleta. Se lo declara junto a `AG-00031`, con su contrato citado y no duplicado. |
