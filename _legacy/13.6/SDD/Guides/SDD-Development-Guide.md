...
| --- | --- | --- |
| `SDD/Devs/Rules/` | Los diecinueve archivos normativos: doce de categoría más siete transversales, `Root-Rules`, `Intake-Rules`, `Maqueta-Rules`, `Deriva-Rules`, `Vocabulario-Rules`, `Migracion-Rules` y `Rules-Base-Conocimiento`. Cada uno define qué produce su categoría, con qué estructura y bajo qué criterios | En casi toda extensión |
