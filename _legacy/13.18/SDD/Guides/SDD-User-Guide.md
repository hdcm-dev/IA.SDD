...
| Contexto de lectura | Lo que un lector tiene efectivamente delante, y lo decide su lista de insumos: **la sección cuando se la nombran, el archivo cuando se lo pasan entero**. Para vos es el documento. Un subagente recibe por secciones el intake y las reglas transversales, y enteros la regla de su categoría y los documentos anteriores; el auditor recibe archivos enteros. De ahí salen dos criterios: si los sentidos de una palabra se distinguen solo leyendo el documento entero, para quien recibe la sección colisionan; y si un archivo se lee entero, un segundo sentido en cualquier parte de él convive con el primero. |
