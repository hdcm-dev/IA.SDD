...
| **Bloque `009xx`** | **Reservado** a los roles que **no son de categoría**. `AG-00990` es el titular de nivel producto; **`AG-00980` es el bibliotecario de conocimiento**, que resuelve pedidos contra el catálogo `Conocimiento/` y cuyo contrato vive en `Rules-Base-Conocimiento.md` §9; **`AG-00970` es el presidente de mesa**, que convoca y consolida la mesa de evaluación y cuyo contrato vive en `Mesa-Rules.md` §1.1 |
...
| --- | --- | --- |
| `009N0`, **descendiendo desde `00990`** | Un rol que no es de categoría | `AG-00990` titular de producto; `AG-00980` bibliotecario de conocimiento; `AG-00970` presidente de mesa |
