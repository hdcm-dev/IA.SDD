...
**Estado de cableado, y hay que declararlo.** Hoy el catálogo se puede **poblar** pero el orquestador **todavía no lo consume en una corrida**: la cita desde el intake y la inyección en el despacho son trabajo pendiente. Mientras tanto, un documento de conocimiento sirve como referencia para quien extiende, no como insumo automático de una generación.
