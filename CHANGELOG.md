...
### Cambiado — `Root-Rules.md` 7.1 → 8.2, §9.1, §9.2 y §10
...
| --- | --- | --- |
| `SDD/Docs/README.md` del destino | El identificador del rol en la columna **Responsable** de su mapa de documentación, **con la forma nueva** | `Root-Rules.md` §9.2, ahora que la familia `AG` está alcanzada. La comprobación 4 de `Master-Prompt.md` §10.0 lo verifica |
...
**El trabajo es el mismo para todos y es mínimo:** reemplazar la cita del rol por su forma nueva, con el mapeo de arriba, que **se lee al revés sin ambigüedad**. **Una sustitución mecánica, en un solo archivo, por unidad de entrega.**
