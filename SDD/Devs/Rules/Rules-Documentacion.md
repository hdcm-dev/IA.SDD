...
| 5.5 | 2026-08-22 | §3.2 decía que sus identificadores son únicos en el producto «como el resto de los identificadores **del framework**», mezclando los **dos ámbitos** que `Root-Rules.md` §9.1 acaba de separar: `OPS`, `EXT`, `EVE`, `ISSUE` y `VER` son familias **del producto**. Sube **minor**: precisa una atribución sin cambiar la regla. |
