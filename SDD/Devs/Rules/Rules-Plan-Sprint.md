...
**Unidad de entrega:** Turnos-Medicos-API
...
```text
Sos un {{ESPECIALIDAD-VARIANTE}} responsable de redactar el plan de sprint de la unidad de entrega {{NOMBRE_UNIDAD_ENTREGA}}.
...
Salida: SDD/Docs/Unidades-Entrega/{{NOMBRE_UNIDAD_ENTREGA}}/07-Plan-Sprint/<estructura>.
```
