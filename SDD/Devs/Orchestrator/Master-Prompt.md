...
| 8.11 | 2026-08-22 | La tabla de invariantes que §5 **le presenta al usuario** declaraba heredar **D3** con la redacción anterior —«únicos en el producto»—, y D3 pasó a «únicos en su ámbito declarado». Una copia declarada de una invariante que dejó de decir lo que la invariante dice. Sube **patch**: corrige una cita sin cambiar ningún procedimiento. |
