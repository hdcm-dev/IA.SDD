...
- No redacta contenido de categorías; eso es trabajo de AG-00000 a AG-00110 y AG-00990.
...
de estas familias son únicos en el producto (`Root-Rules.md` §9.1, primer ámbito), de modo que el reparto tiene que existir **antes**
...
- Ámbito de unicidad: el producto, dentro de cada familia — el primero de los dos de Root-Rules.md §9.1
...
| Tipo de identificadores | `NB-XXXXX`, `CU-XXXXX`, `RN-XXXXX`, `ADR-XXXXX`, `US-XXXXX`, `BT-XXXXX`, `RC-XXXXX`, `TC-XXXXX`, con cinco dígitos uniformes, únicos en su ámbito — **el producto** para estas familias (`Root-Rules.md` §9) | Heredado D3 y D4. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| A | 00-Contexto | producto | `Vision-Producto.md`, `Alcance-Producto.md`, `Roadmap-Producto.md`, `Compatibilidad-Plataformas.md` (según §2.2), `Acuerdo-Equipo.md` (si `equipo_n` > 2), `README.md` | Product Manager Senior (AG-00000) | PRODUCT-INTAKE Parte A (negocio); §13 a §16 (composición) | `Rules-Contexto.md` | `SDD/Docs/00-Contexto/` | Sí |
| A | 01-Necesidades-Negocio | producto | `Necesidades-Negocio.md`, `Necesidades-De-Negocio/NB-XXXXX-<Nombre>.md` (mínimo 3), `README.md` si > 5 NB | Analista de Negocio Senior (AG-00010) | PRODUCT-INTAKE Parte A (negocio); 00-Contexto | `Rules-Necesidades-Negocio.md` | `SDD/Docs/01-Necesidades-Negocio/` | Sí |
| B | 02-Especificacion-Funcional | unidad de entrega | `Especificacion-Funcional.md`, `Casos-De-Uso/CU-XXXXX-<Nombre>.md`, `Reglas-De-Negocio/RN-XXXXX-<Nombre>.md` (si aplica), `Modelo-Datos/...` (si hay persistencia), `Glosario-Funcional.md`, `README.md` | Analista Funcional Senior (AG-00020) + variante D8 de la unidad de entrega | 01/NB-XXXXX, 00; §17 P.x de la unidad de entrega | `Rules-Especificacion-Funcional.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/02-Especificacion-Funcional/` | Sí |
| B | 03-UX-UI-DX | unidad de entrega | Variante UX/UI o DX según `tiene_ui_final`, `README.md` | Especialista UX/UI o DX (AG-00030) + variante D8 de la unidad de entrega | 02 de la unidad de entrega, 00 | `Rules-UX-UI-DX.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/03-UX-UI-DX/` | Sí |
| B | 04-Prompts-AI | unidad de entrega | Si `usa_llm` de la unidad de entrega == true: artefactos de prompts; si false: omitir | Ingeniero de Prompts Senior (AG-00040) + variante D8 de la unidad de entrega | 01, §17 de la unidad de entrega, 02 de la unidad de entrega | `Rules-Prompts-AI.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/04-Prompts-AI/` (solo si gating positivo) | Sí (si se generó) |
| B2 | Validación visual de maqueta | unidad de entrega | Solo si `requiere_maqueta` de la unidad de entrega == true: maqueta navegable en `SDD/Maquetas/<Nombre>/` (`index.html`, un HTML por superficie clave, `assets/css/`, `assets/js/Datos-Maqueta.js`, `assets/js/Maqueta.js`, `README.md`); retroalimentación de 03 y de las categorías que la matriz de propagación alcance; `Linea-Base-Visual.md`, `Contrato-Datos-Maqueta.md` y `Bitacora-Validacion-Maqueta.md` en 03; `Matriz-Sensado-Deriva.md` en 08; si el humano lo acepta, modelo en `../IA.SDD/SDD/Devs/Modelos-UX-UI/` y template ofuscado en `../IA.SDD/Templates/` | Maquetador de validación visual (AG-00031) + variante D8 de la unidad de entrega | 03 del proyecto de código (`Experiencia-De-Uso`, wireframes, representaciones, glosario), 02 de la unidad de entrega (CU, RN, modelo conceptual y sus ejemplos), 00 | `Maqueta-Rules.md`, `Deriva-Rules.md`, catálogo `References/Design/`, catálogo `Modelos-UX-UI/` | `SDD/Maquetas/<Nombre>/`, `SDD/Docs/Unidades-Entrega/<Nombre>/03-UX-UI-DX/`, `SDD/Docs/Unidades-Entrega/<Nombre>/08-Calidad-Y-Pruebas/` | Sí (si se ejecutó) |
| C | 05-Arquitectura-Tecnica | unidad de entrega + producto | Por unidad de entrega: `Arquitectura-Unidad-Entrega.md`, `Decisiones-Arquitectura.md`, `Adrs/ADR-XXXXX-<Nombre>.md`, modelo lógico/flujo/contratos/extensibilidad según flags, `README.md`. Nivel producto: vista de producto en `Producto/` (mapa de proyectos de código, contratos inter-proyecto, grafo) | Arquitecto de Software Senior (AG-00050) + variante D8 de la unidad de entrega | 02, RN, modelo conceptual; 04 del proyecto de código; 00 | `Rules-Arquitectura-Tecnica.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/05-Arquitectura-Tecnica/` y `SDD/Docs/Producto/` | Sí |
| D | 06-Backlog-Tecnico | unidad de entrega | `Product-Backlog.md`, `Backlog-Tecnico.md`, US/BT individuales según umbrales, `Definition-Of-Ready.md`, `README.md` | Scrum Master / Agile Coach (AG-00060) + variante D8 de la unidad de entrega | 01; 02; 05 del proyecto de código | `Rules-Backlog-Tecnico.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/06-Backlog-Tecnico/` | Sí |
| D | 07-Plan-Sprint | unidad de entrega | Si `equipo_n` > 1: sprint plan completo; si == 1: `Mini-Plan.md`, `README.md` | Scrum Master / Gestión Ágil Senior (AG-00070) + variante D8 de la unidad de entrega | 06 del proyecto de código; 02; 05 | `Rules-Plan-Sprint.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/07-Plan-Sprint/` | Sí |
| E | 08-Calidad-Y-Pruebas | unidad de entrega | `estrategia-calidad`, `estrategia-testing`, `plan-pruebas`, `matriz-cobertura-pruebas`, `casos-prueba-referenciales`, `criterios-validacion`, `definition-of-done`, `guia-testing-extensibilidad` (si aplica), `README.md` | Ingeniero QA / SDET Senior (AG-00080) + variante D8 de la unidad de entrega | 02; 05; 06; 07 del proyecto de código | `Rules-Calidad-Y-Pruebas.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/08-Calidad-Y-Pruebas/` | Sí |
| F | 09-Devops | unidad de entrega | `pipeline-ci-cd`, `estrategia-versionado`, `entornos-deploy`, `guia-publicacion-<tipo-artefacto>` (según §2.2), `supply-chain-seguridad`, `README.md` | Ingeniero DevOps Senior (AG-00090) + variante D8 de la unidad de entrega | 05; 08 del proyecto de código; §17 de la unidad de entrega | `Rules-Devops.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/09-Devops/` | Sí |
| G | 10-Examples | unidad de entrega | Pasada de diseño: `README.md` + `ejemplo-XXXXX-<Nombre>.md` (mínimos por tipo) con su `Contrato de verificación` y `evidencia` en `No verificado — sin código`; `/samples` esqueletado; `Imagenes/` si hay assets | Developer Advocate / Sample Engineer Senior (AG-00100) + variante D8 de la unidad de entrega | 02; 05; 06 del proyecto de código | `Rules-Examples.md`, `Deriva-Rules.md` | `SDD/Docs/Unidades-Entrega/<Nombre>/10-Examples/` | Sí (si se generó) |
...
- Para la categoría 03 de proyectos de código con UI (`tiene_ui_final` == true), el despacho de AG-00030 suma como insumo el catálogo de reglas de diseño: el índice `References/Design/Index-Design-Rules.md`, el documento base `Design-Rules-Web-Generico.md` y, si existe, la especialización del stack declarado en la Parte C del intake (por ejemplo `Design-Rules-Blazor-Mudblazor.md`). Es un insumo normativo adicional para 03; no altera la mecánica plan-then-confirm ni las fases.
- Para proyectos de código con superficies de configuración (parámetros que el usuario fija), el despacho de AG-00030 suma además la extensión por capacidad del catálogo `Design-Rules-Config-Esquema.md`, vía el mismo índice. Es ortogonal a la especialización por stack y sigue siendo un insumo normativo; no altera la mecánica plan-then-confirm ni las fases.
- Para proyectos de código que se despliegan por instancia y arrancan sin la configuración mínima que los hace utilizables, el despacho de AG-00030 suma `Design-Rules-Primer-Arranque.md`, vía el mismo índice.
- Para proyectos de código con una sola identidad de operación (sin gestión de usuarios ni roles diferenciados), el despacho de AG-00030 suma `Design-Rules-Acceso-Monousuario.md`, vía el mismo índice.
- Para proyectos de código que producen artefactos desplegables identificables, el despacho de AG-00030 suma `Design-Rules-Identidad-De-Version.md`, vía el mismo índice. En proyectos de código sin UI final la capacidad se materializa en la superficie DX correspondiente.
...
1. Para cada categoría a generar, el orquestador abre `Rules-<Categoria>.md` (o `Root-Rules.md` para AG-00990).
...
**El lote de la fase: las detenciones salen juntas, y antes de salir se miran juntas.** El registro
agrupa lo que el humano **ya difirió**, es decir después de que cada consulta salió de a una. Dentro del
bucle de fases no había un momento en que las detenciones de una misma fase se miraran juntas **antes**
de presentarse por primera vez, y dos consultas que se resuelven mirándose entre sí llegaban separadas.
La forma ya estaba escrita, fundada y probada dentro de la mesa —`Mesa-Rules.md` §7.1: agrupadas al
cierre, con excepción para lo bloqueante y con el campo `SI NO RESPONDÉS`— y el bucle de fases la hereda:

- **Lo que no bloquea espera al lote.** Una detención de la fase que no es bloqueante no se presenta en
  el momento: el orquestador sigue con lo que puede avanzar y la presenta en el lote.
- **Lo bloqueante son dos casos, y sólo dos.** El **arbitraje de este mismo §7.0** —extender o
  contradecir un conjunto cerrado aprobado, que es el análogo de los disparadores 2 y 3 de la mesa— y
  **la detención sin cuya respuesta ninguna otra unidad de la fase puede avanzar**. Esas salen en el
  momento, con la forma de §8.1.
- **El lote sale al cerrar la fase**, junto con el informe de audit y este registro, **o cuando la fase
  ya no puede avanzar sin respuesta**, lo que ocurra primero.
- **Antes de salir, el lote se mira entero.** El orquestador calcula el **origen del hecho** de cada
  detención (§8.1) y aplica la autocorrección **sobre el lote**: la detención cuyo hecho produjo otra
  unidad de esta misma corrida, o que se contesta con otra detención del mismo lote, se resuelve acá y
  no sale.
...
tanto», que es un campo que la fila ya tiene. **La fila no suma una columna de origen del hecho**, y es
deliberado: el origen del hecho se recalcula contra la base de la corrida cada vez que hace falta, y copiarlo
sería mantener dos declaraciones en paralelo.
...
Fase H — Consolidación de producto, plan documental y handoff (una vez, al cerrar todos los proyectos de código).
  1. AG-00050 consolida la vista de producto en `Producto/Vista-Producto.md` (mapa de proyectos de código, contratos inter-proyecto, grafo de dependencias).
  2. AG-00090 consolida el pipeline de producto en `Producto/Pipeline-Producto.md` (orden de construcción topológico, matriz de artefactos publicables por unidad de entrega, coordinación inter-proyecto). Solo si el producto tiene más de un proyecto de código.
  3. AG-00990 redacta `SDD/Docs/README.md` consolidando el producto y la tabla de proyectos de código.
  4. AG-00110 emite el plan documental de la categoría 11, que es el Momento 1 de `Rules-Documentacion.md` §0.3: la lista de artefactos por proyecto de código con su rol de intervención y su estado `Planificado`, sin contenido redactado. Se presenta junto con el resto de la consolidación para que el humano vea qué documentación va a existir al final.
...
Si el bloque dice EXISTENTE, el orquestador ya archivó el estado previo del entregable en la ruta indicada, antes de construir este despacho. No lo archives de nuevo: editás el archivo vivo. Si al abrir el entregable encontrás contenido que el snapshot no refleja, detenete y devolvelo como ambigüedad según §9, sin editar. No declares de dónde salió ese contenido: su origen del hecho lo calcula el orquestador.
...
- **El snapshot no es la base de la corrida, y no sirve para calcular el origen del hecho de §8.1.** Se toma al construir **este** despacho, de modo que ya contiene lo que dejaron las unidades anteriores de la misma corrida: contra él, un estado que otra unidad dejó a medias **se lee como previo**, que es exactamente el valor equivocado. Cuando el subagente devuelve contenido que el snapshot no refleja —una edición ajena, o un despacho paralelo de esta misma corrida sobre un proyecto compartido—, **el orquestador calcula el origen del hecho contra la base de la corrida antes de elevarlo**: si es de la corrida, no es una consulta al humano sino trabajo del lote de §7.0.
...
DETENCIÓN — {{familia}} · {{qué hay que decidir, en una línea}}
  ...
  ORIGEN DEL HECHO                        (lo calcula el orquestador; nunca lo declara quien tropezó)
  ...
  SI NO RESPONDÉS                         (obligatorio si sale en el lote de §7.0)
    {{qué rige por defecto y qué queda bloqueado}}
...
**Detectar un defecto propio y ofrecerlo como opción es entregar trabajo a medias.** Hay que separar tres
...
| **Un estado a medias que produjo esta corrida** —un documento empezado y no cerrado, una decisión tomada y no asentada, una inconsistencia introducida en una unidad anterior— | **El agente, sobre el conjunto de lo que la corrida produjo.** No se corrige en el punto donde se tropezó: se reconstruye desde la base de la corrida qué se tocó y en qué unidades, se cierra lo que falta en todas, y **se declara en el cierre con su alcance ampliado** a las unidades tocadas |
...
**Antes de la pregunta previa, el origen del hecho — y no se le pregunta al agente.** La pregunta
previa corta por un solo eje: si el árbol tiene la respuesta. **Un estado que la propia corrida dejó a
medias no la tiene por construcción** —nadie la escribió—, y con el criterio literal cae del lado de
detener: llega al humano con la forma de una consulta legítima. Lo que lo distingue es **de dónde salió
el hecho que motiva la detención**, y ese dato **se calcula**:

> **Origen del hecho.** Se contrasta el hecho —las líneas que lo sostienen, o el documento donde falta—
> contra la **base de la corrida** (§12.1 T0). Es **de la corrida** si esas líneas no están en la base,
> o están y un commit de las ramas de esta corrida las cambió. Es **ajeno a la corrida** si están en la
> base sin cambios, o si las cambió un commit que no es de esta corrida. Si no se puede calcular —el
> hecho no vive en ningún repositorio, la base no se publicó, el historial se reescribió— **se trata
> como de la corrida**, y la detención dice por qué no se calculó.

**Por qué se calcula y no se declara.** Un agente que no se dio cuenta de que generó el problema declara
«ajeno» de buena fe, y el requisito queda cumplido en la forma y no en el fondo: la declaración sería
**el mismo juicio del agente sobre su propio trabajo** que esta sección tiene anotado como el límite de
la pregunta previa. Por eso lo calcula **el orquestador**, que tiene la base y los despachos, y no el
subagente que tropezó.

**Por qué la base y no el snapshot de §8.** El snapshot se toma al construir cada despacho y ya contiene
lo que dejaron las unidades anteriores: contra él, el estado a medias de otra unidad se lee como previo.
La base se toma **una vez, sobre el árbol entero y con todo commiteado** —T2 lo garantiza—, y el
historial no la sobrescribe.

| Origen del hecho | Contra qué se evalúa | Cuándo se detiene igual |
| --- | --- | --- |
| **Ajeno a la corrida** | **La pregunta previa**, como hasta ahora | Cuando no tiene cita posible en el árbol |
| **De la corrida**, calculado o por duda | **La autocorrección sobre el conjunto**, la tercera fila de la tabla de arriba. **No se evalúa contra el árbol** | Sólo si corregirlo **cambia una decisión que el humano ya tomó** —la contraparte de arriba—, si es un **arbitraje** de §7.0, o si cerrarlo exige **intención de producto que ninguna fuente contiene**. Y sale declarando **por qué la autocorrección no alcanzaba** |

**Ante la duda sobre el origen del hecho, de la corrida**, por la misma asimetría con que se decide detener:
tratar como ajeno lo que produjo la corrida le devuelve al humano un problema que no era suyo, y tratar
como de la corrida lo que era ajeno cuesta una autocorrección que igual se detiene si toca una decisión
del humano. **Y lo que el cálculo mostró ajeno no se reescribe «corrigiendo»**: la duda habilita a
intentar, no a pisar.

**No es el eje de estratos que la 9.19 rechazó, y conviene decirlo porque se parecen.** Aquél era una
**clasificación por juicio** de quién puede cerrar un hallazgo, paralela a la pregunta previa, y la cita
literal la volvía innecesaria. Esto es **un dato calculado de un observable** que ordena **qué prueba
corre primero**, y la cita no lo reemplaza: un estado a medias de la corrida **no tiene cita posible**.
Declarado por el agente, sí sería aquel eje con otro nombre.
...
**Ante la duda, se detiene** —sobre un hecho ajeno a la corrida—. Clasificar mal hacia «lo resuelvo yo» es peor que hacia «lo pregunto»: el
...
**Lo resuelto por la tercera fila se declara con su alcance** —qué unidades de la corrida tocó— y con la
base contra la que se calculó su origen del hecho. **Y ninguna detención cuyo origen del hecho sea «de la corrida» sale sin
declarar por qué la autocorrección no alcanzaba**, que es enumerable y se cuenta sobre el lote. **Una
cuenta en cero no prueba que la regla funcione**: si en una corrida con detenciones ninguna resulta de
la corrida, y `Corregido` tampoco registra nada por la tercera fila, lo primero que hay que mirar es si
el origen del hecho se calculó o se declaró. Y el renglón `Cómo` separa lo calculado de lo tratado por duda: todas
por duda muestran que la base no se está usando.
...
**Esta sección no agrega ninguna detención.** **Sí quita** —y lo hace desde la pregunta previa, aunque
esta línea dijo lo contrario hasta la 8.14—: las que tienen respuesta en el árbol, y las que produjo la
corrida y la autocorrección cierra. A las que quedan les cambia **la forma**. Y no autoriza a decidir: la propuesta es un insumo, y las tres prohibiciones de §13 sobre
...
2. Sintetiza la pregunta concreta en este formato:
   ...
   - **Origen del hecho**: {{no lo completa el subagente: lo calcula el orquestador según §8.1 antes de presentar}}
   ```
3. El orquestador calcula el origen del hecho de cada una (§8.1) y las presenta en el lote de §7.0, con copy paste literal del bloque. Sólo sale en el momento la que §7.0 declara bloqueante, y la que resulta de la corrida y la autocorrección cierra no se presenta: se declara en el cierre.
...
7. **Localización de los términos declarados** (`Vocabulario-Rules.md` §9.2 y §9.4): por cada término que la
   fase **declara acuñar o renombrar**, la compuerta devuelve sus ocurrencias **por sección y por archivo**,
   sobre el árbol de la fase y sobre los insumos que reciben sus lectores. **Es la única comprobación de esta
   lista que no emite hallazgo**: entrega la lista al auditor **como insumo**, y **nunca un veredicto de
   colisión**. Localizar es contar; decidir si una ocurrencia tiene otro referente es leer, y un guion que lo
   decidiera sería la falsa confianza que `Vocabulario-Rules.md` §10 declara peor que no verificar.

   **Qué términos, y por qué no un registro.** Los que la fase agrega a un glosario de categoría o a §15, y
   los de todo registro de sustitución de `Vocabulario-Rules.md` §9.5, **calculados contra la base de la
   corrida** (§12.1 T0) y no declarados aparte: un registro de términos acuñados sería una fuente declarativa
   más, que sigue afirmando «no colisiona» el día que alguien edita una sección sin tocarlo. **Nunca prosa
   libre**: una palabra común devuelve cientos de coincidencias y apaga el instrumento, el mismo argumento con
   que la comprobación 1 excluyó `_legacy/`. Medido sobre `SDD/` en la 13.11: los tres términos que esa versión acuñó, y
   `procedencia`, aparecen en entre cuatro y quince archivos cada uno y se localizan en milisegundos; `estado`
   como palabra entera da 711 ocurrencias en 90 archivos (`grep -rnowiF --include='*.md' estado SDD | wc -l`).

   ```bash
   # T: término declarado · ARBOL: el árbol de la fase y los insumos de sus lectores. Una línea por sección, y el total del archivo.
   t=$(printf '%s' "$T" | tr '[:upper:]' '[:lower:]')
   for f in $(grep -rliF --include='*.md' "$T" $ARBOL); do
     awk -v t="$t" -v f="$f" 'BEGIN{s="(antes del primer título)"} /^```/{c=!c} !c && /^#{1,6} /{s=$0}
       {l=tolower($0); while((i=index(l,t))>0){if(!(s in n)){k++;o[k]=s}; n[s]++; tot++; l=substr(l,i+length(t))}}
       END{for(j=1;j<=k;j++) printf "%s\t%s\t%d\n",f,o[j],n[o[j]]; printf "%s\t(archivo)\t%d\n",f,tot}' "$f"
   done
   ```

   **Qué hace el auditor con la lista.** Por cada ocurrencia con otro referente, mira si comparte contexto de
   lectura con el sentido declarado **para alguno de los lectores de ese archivo** (`Vocabulario-Rules.md`
...
- Coherencia cross-doc dentro de la fase: referencias entre archivos resuelven, IDs no duplicados y **gobierno del glosario** en sus cuatro criterios:
  ...
  - **Polisemia gobernada**: todo término con más de un referente dentro de la fase tiene entrada de glosario que los declara, o forma calificada en todas las ocurrencias que colisionan. El criterio de colisión es el de `Vocabulario-Rules.md` §9.2: el contexto de lectura es la unidad con que **cada lector** recibe el texto —la sección cuando su lista la nombra, el archivo cuando no—, y la forma desnuda de una familia calificada es el caso a mirar. **La lista de la comprobación 7 de §10.0 es su insumo**, y toda afirmación de colisión o de no colisión trae su comando (`Vocabulario-Rules.md` §9.4).
...
Al cierre del bucle de proyectos de código, el orquestador despacha primero a AG-00050 para consolidar la vista de producto en `SDD/Docs/Producto/` y luego a AG-00990 para redactar `SDD/Docs/README.md`.

Vista de producto (AG-00050, regla `Rules-Arquitectura-Tecnica.md`): en `Producto/Vista-Producto.md`, **los dos ejes del producto y el puente entre ellos**. Es el artefacto donde vive el eje de construcción completo, porque el proyecto de código no tiene árbol propio.
...
| Grafo de compilación | Las aristas entre proyectos de código, acíclico, **cada una con su clase**: referencia de proyecto o insumo de construcción (`Intake-Rules.md` §4). Es el que ordena el build del pipeline de producto |
...
Salida única de AG-00990: `SDD/Docs/README.md` con cabecera obligatoria, secciones obligatorias y tablas completas según `Root-Rules.md`, incluyendo la tabla de proyectos de código del producto.
...
COMPUERTA DE ARRANQUE — {{repositorio}}
  ...
  Base:            {{commit completo sobre el que corre esta compuerta}}
...
**La línea `Base` es la base de la corrida**, y es lo que §8.1 usa para calcular el origen del hecho. Es
el commit sobre el que **la primera** T0 de la invocación devolvió EN ORDEN: con el árbol limpio que T2
exige, todo lo que la corrida encuentra ahí es anterior a ella. **No cambia en toda la corrida**: T5 la
vuelve a publicar igual y la continuación de `Master-Prompt-Reanudacion.md` R4 la hereda. Una invocación
nueva abre una corrida nueva y publica la suya. **Si la compuerta se detiene, no hay base**, porque la
corrida no empezó. El dato ya se tomaba —la compuerta corre sobre un commit— y **no se registraba**.
...
4. **Deja el repositorio en el estado que la unidad siguiente necesita**, y lo publica con el formato
   de T0 y **la misma línea `Base`**, que es la de la corrida y no la principal de ahora. Terminar el merge y arrancar lo próximo sobre un local a medio actualizar es la forma de
...
| Product Owner | Rol humano, aguas arriba del intake y fuera de la cadena AG-XXXXX. Conoce el producto, reúne el material que lo define, **arbitra** entre intereses de stakeholders en conflicto y declara las decisiones de producto en el `PRODUCT-INTAKE`: la priorización MoSCoW de §4 y las exclusiones de §9. Es el autor responsable del intake y quien lo aprueba. Ninguna especialidad AG-XXXXX toma esas decisiones por él: si faltan, se aplica el patrón de ambigüedad legítima de §9. No confundir con AG-00000 (Product Manager), que opera aguas abajo y formaliza lo ya decidido. |
...
| Contexto de lectura | La unidad con la que la lista de insumos de un lector le entrega el texto: **la sección cuando la nombra, el archivo cuando lo nombra sin sección**. Para el humano es el documento. Un subagente recibe por secciones el intake y las reglas transversales, y enteros la regla de su categoría y sus upstream (§8); el auditor y el orquestador de migración, archivos enteros. Es la unidad sobre la que se decide si dos sentidos de un término colisionan, y **la suma de lo que un lector recibe no es una unidad** (`Vocabulario-Rules.md` §9.2). |
...
| Compuerta mecánica | Comprobación automática que corre **antes** de despachar un audit y decide propiedades enumerables: enlaces que resuelven, recuentos anclados que coinciden, generadores idempotentes e identificadores bien formados; y **localiza sin decidir** los términos que la fase declara acuñar o renombrar. Su salida es insumo del despacho del auditor y **declara qué no mira**. Definida en §10.0. |
| Glosario operativo | Esta sección: el glosario del **vocabulario del método**. Es el destino declarado de todo término que el framework acuña y usa en más de uno de sus artefactos. La documentación de un producto lo **cita sin redefinirlo**; el vocabulario del producto va a los glosarios de categoría. **Define y no decide colisiones**: si dos sentidos de un término del método chocan, lo decide `Vocabulario-Rules.md` §9, como para cualquier otro término. |
