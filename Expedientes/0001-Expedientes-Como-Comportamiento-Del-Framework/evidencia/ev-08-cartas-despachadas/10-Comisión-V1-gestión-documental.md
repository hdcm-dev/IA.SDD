...
## Leé primero, enteros
- `/IA/SDD/IA.SDD/Expedientes/0001-Expedientes-Como-Comportamiento-Del-Framework/actuaciones/001-presentacion-del-product-owner.md` (el caso) y `002-providencia-convocatoria-de-mesa.md` (contrato de entrada, restricciones duras, decisiones cerradas, tu carta en §3.2 V1)
- `/IA/SDD/IA.SDD-exp1/SDD/Devs/Rules/Mesa-Rules.md` (§2, §4, §6.1)
- `evidencia/*.out` del mismo expediente
- Del framework (`/IA/SDD/IA.SDD-exp1/`): README.md, SDD/Guides/SDD-Development-Guide.md §VI.4-§VI.5, SDD/Devs/Rules/Root-Rules.md §9-§12, SDD/Devs/Orchestrator/Master-Prompt.md §8.1-§8.2, Master-Prompt-Reanudacion.md §5, Deriva-Rules.md §1. Destinos sólo lectura: `/PROG2/Geometria/Lab-Geometria` **por `git show main:<ruta>` / `git ls-tree main`** (otra corrida escribe ahí), `/Repos-RPIs/RPI.VideoControl`. Registros de mesa previos: `/IA/SDD/IA.SDD.Documentacion-exp1/PROMPTs/Fixs/*/OUTPUTs/`.
