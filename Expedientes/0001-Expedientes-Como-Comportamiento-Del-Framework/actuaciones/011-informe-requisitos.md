...
- **Autosuficiencia** (`README.md` l.152): *«Ningún archivo de este repositorio referencia otro repositorio»*. El expediente 0001 ya la incumple. Medido con `grep -rnoE '/home/[^ \`]*|IA\.SDD\.Documentacion[^ \`]*' Expedientes`: aparece en `README.md` l.5 y l.21, `ev-03-colision.sh` l.3, l.6 y l.13, `ev-04-inventario.sh` l.3, l.11 y l.12, y `ev-05-citas.sh` l.4. Hay rutas absolutas `/home/fernando/...` y citas a `IA.SDD.Documentacion`.
